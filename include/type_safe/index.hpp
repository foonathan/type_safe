...
namespace type_safe
{
    ...
    struct distance_t : strong_typedef<distance_t, detail::distance_t>,
                        strong_typedef_op::equality_comparision<distance_t>,
                        strong_typedef_op::relational_comparision<distance_t>,
    ...
    struct index_t : strong_typedef<index_t, detail::index_t>,
                     strong_typedef_op::equality_comparision<index_t>,
                     strong_typedef_op::relational_comparision<index_t>,
