...
namespace type_safe
{
    ...
    public:
        ...
        /// \notes (2) only participates in overload resolution if the type of the function is compatible
        ...
        template <typename Functor,
                  typename = detail::enable_function_tag<detail::matching_function_pointer_tag,
                                                         Functor, Return, Args...>>
